...
class StackWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.abduhanifan.dicoding.githubuserapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.abduhanifan.dicoding.githubuserapp.EXTRA_ITEM"
